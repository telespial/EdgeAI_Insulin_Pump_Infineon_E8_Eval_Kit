...
static const predictor_v2_generated_model_t k_model_15m =
{
    .feature_mean = {
        ...
        1.0f, 75.0f, 20.0f, 18.0f, 30.0f, 15.0f,
    },
    .feature_scale = {
...
static const predictor_v2_generated_model_t k_model_30m =
{
    ...
    .coefficients = {
        ...
        0.6f, 0.5f, 0.3f, 0.3f, 0.15f, 0.15f,
    },
    .intercept = 0.0f,
    .valid = true,
};
