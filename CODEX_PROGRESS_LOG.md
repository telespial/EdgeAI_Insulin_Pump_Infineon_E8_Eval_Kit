...
- 2026-06-14: Unified the visible glucose paths onto the APS demo-state / virtual-patient source and fixed the startup seeding path so the dashboard no longer appears to run out of data after the first few points. Predictor V2, controller, and safety remain active in the live research/demo loop.
